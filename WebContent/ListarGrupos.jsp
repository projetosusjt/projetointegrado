          					...
          					<c:forEach var="grupo" items="${lista }">
                                       <tr>
                                            ...
                                            <td class="actions">
                                                ...
                                                <a class="btn btn-warning btn-xs" href="ManterGrupo.do?acao=Editar&id=${grupo.grupo_id }">Editar</a>
                                                <button id="btn${grupo.grupo_id }%>" type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete-modal" data-cliente="${grupo.grupo_id}">Excluir</button>
                                            </td>
                                        </tr>
                            </c:forEach>
